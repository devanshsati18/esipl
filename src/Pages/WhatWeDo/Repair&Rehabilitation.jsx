...
const solutionContent = {
    Safety: {
    title: "Safety",
    content: "Ensures that structures remain safe for use, reducing the risk of accidents or failures.",
    image: "https://via.placeholder.com/400x250/ff6347",
  },
    CostEffectiveness: {
    title: "Cost-Effectiveness",
    content: "Extending the life of existing structures can be more economical than complete replacement.",
    image: "https://via.placeholder.com/400x250/4682b4",
  },
  Sustainability:  {
    title: "Sustainability",
    content: "Rehabilitation promotes the efficient use of resources by maximizing the lifespan of existing infrastructure.",
    image: "https://via.placeholder.com/400x250/ff6347",
  },
};
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center gap-8">
        ...
        >
          <h2 className="text-5xl font-bold text-orange-500 mb-4">
            Understanding Repair & Rehabilitation
          </h2>
          <p className="text-gray-700 leading-relaxed">
          Repair and rehabilitation refer to processes aimed at restoring the functionality and integrity of structures or infrastructure that have deteriorated due to age, wear, environmental factors, or other stresses. These processes are essential in maintaining safety and extending the lifespan of structures.
          </p>
          <p className="text-gray-700 mt-4">
          Repair and rehabilitation are critical processes in infrastructure management, focusing on restoring and enhancing the safety, functionality, and longevity of structures. By addressing damage and preventing future issues, these processes contribute to the sustainability and resilience of built environments.
          </p>
        </motion.div>
      </div>

          ...
          <div className="space-y-12">
            ...
            <div className="timeline-item flex justify-end opacity-0 transform transition-transform duration-500 slide-in-right">
              <div className="bg-white p-6 rounded-lg shadow-lg max-w-lg relative">
                ...
                <div className="absolute top-1/2 transform -translate-y-1/2 right-1/2 translate-x-1/2 w-4 h-4 bg-black rounded-full"></div>
              </div>
            </div>
            ...
            <div className="timeline-item flex justify-start opacity-0 transform transition-transform duration-500 slide-in-left">
              <div className="bg-white p-6 rounded-lg shadow-lg max-w-lg relative">
                ...
                <div className="absolute top-1/2 transform -translate-y-1/2 left-1/2 -translate-x-1/2 w-4 h-4 bg-black rounded-full"></div>
              </div>
            </div>
